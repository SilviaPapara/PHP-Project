...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username_err) && empty($password_err)) {
        ...
        $sql = "SELECT id_, username, password FROM users WHERE username = ?";
...
<body class="background">
    <div class="wrapper rounded col-6 m-auto">
        <h2>Login</h2>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Don't have an account? <a class="link-dark" href="register.php">Sign up now</a>.</p>
        </form>
    </div>
